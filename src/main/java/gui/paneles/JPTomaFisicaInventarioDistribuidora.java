 ...
 * @author Pablo
 */
public class JPTomaFisicaInventarioDistribuidora extends javax.swing.JPanel {
     ...
     */
    public JPTomaFisicaInventarioDistribuidora() {
        initComponents();
        //ComboBoxAlmacenes
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new JPTomaFisicaInventarioDistribuidora().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(JPTomaFisicaInventarioDistribuidora.class.getName()).log(Level.SEVERE, null, ex);
                }
