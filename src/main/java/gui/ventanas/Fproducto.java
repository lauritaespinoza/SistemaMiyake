...
//                    }
    ...
    private void initComponents() {
        ...
        f_codExt = new javax.swing.JTextField();
        f_ref_Product = new javax.swing.JTextField();
        f_precio_alto = new javax.swing.JTextField();
        f_precio_orig = new javax.swing.JTextField();
        f_precio_venta = new javax.swing.JTextField();
                ...
                .addGroup(panelCrearProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelCrearProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(panelCrearProductoLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(f_precio_venta, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(panelCrearProductoLayout.createSequentialGroup()
                            .addGap(10, 10, 10)
                        ...
                        .addGroup(panelCrearProductoLayout.createSequentialGroup()
                            ...
                            .addComponent(f_codExt, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(96, 96, 96)))
                    .addGroup(panelCrearProductoLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(f_precio_alto, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        panelCrearProductoLayout.setVerticalGroup(
            ...
            .addGroup(panelCrearProductoLayout.createSequentialGroup()
                ...
                .addGroup(panelCrearProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(jLabel12)
                    .addComponent(f_codExt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(panelCrearProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelCrearProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel3)
                        .addComponent(jLabel9)
                        .addComponent(f_precio_alto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(panelCrearProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(f_precio_venta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(58, 58, 58)
                .addComponent(bCrearProducto)
                .addGap(135, 135, 135))
        );
        ...
        busy.setMinimumSize(new java.awt.Dimension(200, 200));
        busy.setPreferredSize(new java.awt.Dimension(200, 200));
    ...
    private void bCrearProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCrearProductoActionPerformed
        try {
            ...
            if (!f_descripcionProducto.getText().equals("") && !f_ref_Product.getText().equals("")
                    && !f_codExt.getText().equals("") && !f_precio_alto.getText().equals("")
                    && !f_precio_orig.getText().equals("") && !f_precio_venta.getText().equals("")) {
...
//                field_Cod_Prod_Buscado.setText(field_codproducto.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fproducto.class
    ...
    private javax.swing.JTextField f_codExt;
    private javax.swing.JTextField f_descripcionProducto;
    private javax.swing.JTextField f_precio_alto;
    private javax.swing.JTextField f_precio_orig;
    private javax.swing.JTextField f_precio_venta;
