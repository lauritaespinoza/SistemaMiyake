...
import paneles.FventanaIncial;

public class Pclasificacion extends javax.swing.JPanel {
...
//        dialogo.getContentPane().add(new JScrollPane(new Pdepartamento(1)), BorderLayout.CENTER);
//        dialogo.pack();
...
//        dialogo.setVisible(true);
        ...
        createJDialogGeneric(new Pdepartamento(1));
